...
# Fungsi untuk transformasi data fact_sales
def fact_sales():
...
# Fungsi untuk transformasi data fact_login_attempts
...
# Fungsi untuk transformasi data dim_customers
def dim_customers():
    source_conn = get_conn()
    target_conn = get_conn_dw()
...
# Fungsi untuk transformasi data dim_orders
def dim_orders():
    source_conn = get_conn()
    target_conn = get_conn_dw()
...
# Fungsi untuk transformasi data dim_coupons
def dim_coupons():
    source_conn = get_conn()
    target_conn = get_conn_dw()
...
# Fungsi untuk transformasi data dim_products
def dim_products():
    source_conn = get_conn()
    target_conn = get_conn_dw()
...
# Fungsi untuk transformasi data dim_order_items
def dim_order_items():
    source_conn = get_conn()
    target_conn = get_conn_dw()
...
# Fungsi untuk transformasi data dim_category
def dim_category():
    source_conn = get_conn()
    target_conn = get_conn_dw()
...
# Task untuk transformasi data dim_coupons
...
# Task untuk transformasi data dim_category
...
# Task untuk transformasi data dim_customers
...
# Task untuk transformasi data dim_orders
...
# Task untuk transformasi data dim_products
...
# Task untuk transformasi data dim_order_items
...
# Task untuk transformasi data fact_login_attempts
...
# Task untuk transformasi data fact_sales
